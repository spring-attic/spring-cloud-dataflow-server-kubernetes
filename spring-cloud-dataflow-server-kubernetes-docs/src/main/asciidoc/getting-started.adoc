...
you can with the following command. For more details, review how to link:{dataflow-asciidoc}/streams.adoc#spring-cloud-dataflow-register-apps[register applications].
+
```
