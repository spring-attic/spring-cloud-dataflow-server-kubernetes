...
This is an optional step.  Deploy link:https://cloud.spring.io/spring-cloud-skipper/[Skipper] if you want the added features of upgrading and rolling back Streams since Data Flow delegates to Skipper for those features.
...
```
So the URL you need to use is in this case is: https://130.211.203.247
...
+
```
dataflow:>app import --uri https://bit.ly/Celsius-GA-stream-applications-rabbit-docker
```
+
