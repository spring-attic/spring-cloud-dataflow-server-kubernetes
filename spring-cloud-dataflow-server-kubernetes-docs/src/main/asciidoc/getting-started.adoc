...
NOTE: Properties set on a per application basis will always take precedence over properties set the server configuration. This allows for the ability to override property values set at the server level.
