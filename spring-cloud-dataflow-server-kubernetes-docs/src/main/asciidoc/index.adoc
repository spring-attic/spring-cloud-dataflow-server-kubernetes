...
:docker-http-source-rabbit-version: 2.0.0.RELEASE
:docker-time-source-rabbit-version: 2.0.0.RELEASE
:docker-log-sink-rabbit-version: 2.0.0.RELEASE
:docker-timestamp-task-version: 1.3.0.RELEASE
:skipper-core-version: 1.0.7.RELEASE
