...
:docker-http-source-rabbit-version: 2.0.1.RELEASE
:docker-time-source-rabbit-version: 2.0.1.RELEASE
:docker-log-sink-rabbit-version: 2.0.1.RELEASE
:docker-timestamp-task-version: 2.0.0.RELEASE
:skipper-core-version: 1.0.8.RELEASE
